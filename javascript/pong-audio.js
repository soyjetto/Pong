...
export var wallSound = new soundFile("hitting the wall fr.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("hitting the wall.mp3");
...
export var adventureMusic = new soundFile("adventure wining.mp3");
soundArray.push(adventureMusic);
adventureMusic.player.loop = true;
adventureMusic.player.volume.value = 0;

export var villageMusic = new soundFile("village.mp3");
